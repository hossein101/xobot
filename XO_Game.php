...
define('BOT_TOKEN', '290097041:AAEbwj9-p790qjkJGSQQifm95_2UZk5SNac');
...
function processMessage($message) {
  ...
  if (isset($message['text'])) {
    ...
    if (strpos($text, "/start") === 0) {
      apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => "سلام خوش اومدی😃\nبرای بازی کردن بر روی بازی سرخ ابی کلیک کن و هرجا که خواستی بازی کنی رو انتخاب کن گروه یا پیوی دوستتو\n بعدا میتونی باهاش بازی کنی امید وارم که از این بازی لذت کافی رو ببرین", 'reply_markup' => array(
